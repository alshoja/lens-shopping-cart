                        ...
                        <div class="pl-lg-4">
                            <div class="row">
                                    <div class="col-sm">
                                            ...
                                            placeholder="{{ __('Title') }}" value="{{$contact->title}}" required>
                                ...
                                <div class="col-sm">
                                    <div class="form-group{{ $errors->has('phone') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="phone" id="input-title"
                                            ...
                                            placeholder="{{ __('Phone') }}" value="{{$contact->phone}}" required
                                            autofocus>
                                        @if ($errors->has('phone'))
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-sm">
                                    <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="email" name="email" id="input-password"
                                            ...
                                            placeholder="{{ __('Email') }}" value="{{$contact->email}}" required>
                                ...
                                <div class="col-sm">
                                    <div class="form-group{{ $errors->has('footer_subscribing_data') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="footer_subscribing_data" id="input-password"
                                            ...
                                            placeholder="{{ __('Subscribing Message') }}" value="{{$contact->footer_subscribing_data}}" required>
                                ...
                                <div class="col-sm">
                                        <div class="form-group{{ $errors->has('rights_data') ? ' has-danger' : '' }}">
                                                ...
                                                <input type="text" name="rights_data" id="input-password"
                                                    ...
                                                    placeholder="{{ __('® Rights Message') }}" value="{{$contact->rights_data}}" required>
                                ...
                                <div class="col-sm">
                                        <div class="form-group{{ $errors->has('rights_company_name') ? ' has-danger' : '' }}">
                                                ...
                                                <input type="text" name="rights_company_name" id="input-password"
                                                    ...
                                                    placeholder="{{ __('Company name') }}" value="{{$contact->rights_company_name}}"  required>
                                ...
                                <div class="col-sm">
                                        <div class="form-group{{ $errors->has('company_url') ? ' has-danger' : '' }}">
                                                ...
                                                <input type="url" name="company_url" id="input-password"
                                                    ...
                                                    placeholder="{{ __('http://website.com') }}" value="{{$contact->company_url}}" required>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group{{ $errors->has('map_iframe_data') ? ' has-danger' : '' }}">
                                            ...
                                            <textarea name="map_iframe_data"
                                                ...
                                                placeholder="{{ __('  <iframe src = "/html/menu.htm" width = "555" height = "200"></iframe>') }}">{{$contact->map_iframe_data}}</textarea>

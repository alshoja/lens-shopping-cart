                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('user.store') }}" autocomplete="off">
                            ...
                            <div class="form-group{{ $errors->has('amount') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-email">{{ __('Current Price') }}</label>
                                    <input type="number" name="amount" id="input-email" class="form-control form-control-alternative{{ $errors->has('amount') ? ' is-invalid' : '' }}" placeholder="{{ __('Current Price') }}" value="{{ old('amount') }}" required>
                            ...
                            <div class="col-6 col-md-4">
                                    <div class="form-group{{ $errors->has('old_price') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="number" name="old_price" id="input-email" class="form-control form-control-alternative{{ $errors->has('old_price') ? ' is-invalid' : '' }}" placeholder="{{ __('Old Price') }}" value="{{ old('old_price') }}" required>
                                ...
                                <textarea name="description" class="form-control form-control-alternative{{ $errors->has('description') ? ' is-invalid' : '' }}" id="exampleFormControlTextarea1" value="{{ old('description') }}" rows="3" placeholder="{{ __('Description about product') }}"></textarea>
                            ...
                            @endif
                                ...
                                <div class="form-group{{ $errors->has('stock') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" name="password" id="input-password" class="form-control form-control-alternative{{ $errors->has('stock') ? ' is-invalid' : '' }}" placeholder="{{ __('No of Stock') }}" value="{{ old('stock') }}" required>
